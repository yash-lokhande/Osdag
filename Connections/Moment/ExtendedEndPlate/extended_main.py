...
class Maincontroller(QMainWindow):
   ...
   def osdag_image5(self):  # This function is created for calling the flush stiffener image in design report
   ...
   def osdag_image6(self):  # This function is created for calling the eep stiffener image in design report
