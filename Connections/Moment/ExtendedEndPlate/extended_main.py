...
class Maincontroller(QMainWindow):
	...
	def osdag_image1(self): # This function is created for calling the single butt weld image in design report
		image_path = os.path.abspath(os.path.join(os.getcwd(), os.path.join("Connections/Moment/ExtendedEndPlate/ResourceFiles/images", "Butt_Single.png")))
		shutil.copyfile(image_path, os.path.join(str(self.folder), "images_html", "Butt_Single.png"))

	def osdag_image2(self): # This function is created for calling the double butt weld image in design report
		image_path = os.path.abspath(os.path.join(os.getcwd(), os.path.join("Connections/Moment/ExtendedEndPlate/ResourceFiles/images", "Butt_Double.png")))
		shutil.copyfile(image_path, os.path.join(str(self.folder), "images_html", "Butt_Double.png"))
